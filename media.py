...
class Movie(Media): # Passing Media as an arguement inherits all of Media's attributes
    ...
    def __init__(self, title, poster_image_url, trailer_youtube_url):
        Media.__init__(self, title, poster_image_url) # Inherited variables still need to be initialized
